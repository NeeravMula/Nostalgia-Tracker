...
Project Goal:
The goal of this app is to provide to a way to keep track of feelings that one yearns for from one's youth. Such feelings occur mainly through the items that the individual consumed in a happy context. As such keeping track of those items will allow for the individual to relive those feelings and have a happier life. 
